...
public interface BugLocalizationGraphPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int BUG_REPORT_NODE__LOCATIONS = 2;
	 ...
	 * @ordered
	 */
	int BUG_REPORT_NODE__COMMENTS = 3;
	...
	/**
	 * The meta object id for the '{@link org.sidiff.bug.localization.dataset.graph.impl.BugReportCommentNodeImpl <em>Bug Report Comment Node</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.sidiff.bug.localization.dataset.graph.impl.BugReportCommentNodeImpl
	 * @see org.sidiff.bug.localization.dataset.graph.impl.BugLocalizationGraphPackageImpl#getBugReportCommentNode()
	 * @generated
	 */
	int BUG_REPORT_COMMENT_NODE = 2;
	 ...
	 * @ordered
	 */
	int BUG_REPORT_COMMENT_NODE__COMMENT = 0;

	/**
	 * The number of structural features of the '<em>Bug Report Comment Node</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int BUG_REPORT_COMMENT_NODE_FEATURE_COUNT = 1;

	/**
	 * The number of operations of the '<em>Bug Report Comment Node</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int BUG_REPORT_COMMENT_NODE_OPERATION_COUNT = 0;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link org.sidiff.bug.localization.dataset.graph.BugReportNode#getComments <em>Comments</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	EReference getBugReportNode_Comments();

	/**
	 * Returns the meta object for class '{@link org.sidiff.bug.localization.dataset.graph.BugReportCommentNode <em>Bug Report Comment Node</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Bug Report Comment Node</em>'.
	 * @see org.sidiff.bug.localization.dataset.graph.BugReportCommentNode
	 * @generated
	 */
	EClass getBugReportCommentNode();

	/**
	 * Returns the meta object for the attribute '{@link org.sidiff.bug.localization.dataset.graph.BugReportCommentNode#getComment <em>Comment</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Comment</em>'.
	 * @see org.sidiff.bug.localization.dataset.graph.BugReportCommentNode#getComment()
	 * @see #getBugReportCommentNode()
	 * @generated
	 */
	EAttribute getBugReportCommentNode_Comment();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference BUG_REPORT_NODE__COMMENTS = eINSTANCE.getBugReportNode_Comments();

		/**
		 * The meta object literal for the '{@link org.sidiff.bug.localization.dataset.graph.impl.BugReportCommentNodeImpl <em>Bug Report Comment Node</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.sidiff.bug.localization.dataset.graph.impl.BugReportCommentNodeImpl
		 * @see org.sidiff.bug.localization.dataset.graph.impl.BugLocalizationGraphPackageImpl#getBugReportCommentNode()
		 * @generated
		 */
		EClass BUG_REPORT_COMMENT_NODE = eINSTANCE.getBugReportCommentNode();
		 ...
		 * @generated
		 */
		EAttribute BUG_REPORT_COMMENT_NODE__COMMENT = eINSTANCE.getBugReportCommentNode_Comment();

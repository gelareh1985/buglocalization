...
public abstract class Java2UMLActivityDiagramBasicDiscoverer<T> extends AbstractJava2UMLDiscoverer<T> {

	public static String ID = "eu.artist.migration.mdt.javaee.java.umlactivity.resource";
	
	public Java2UMLActivityDiagramBasicDiscoverer(TransformationProvider<T> transformationProvider) {
	...
	protected void transform(EMFModel javaModel, EMFModel umlModel, IProgressMonitor monitor) throws IOException {
		...
		transformationLauncher.addLibrary("java2UMLActivityHelpers", Java2UMLActivityDiagramBasicDiscoverer.class

...
public class ViewDescriptions {
	...
	public static ViewDescription UML_CLASS_DIAGRAM = SystemModelFactory.eINSTANCE.createViewDescription("UML Class Diagram", "UML class diagram showing the project structure.", "uml.class");
	
	public static ViewDescription UML_CLASS_OPERATION_CONTROL_FLOW = SystemModelFactory.eINSTANCE.createViewDescription("UML Activity Diagram", "UML activity diagram showing the operation control flow.", "cfg.uml.activity");

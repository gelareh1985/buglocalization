...
<table>
  ...
  <tr>
     <td style="width:30%; background-color:#d5e3c8"> Bug Report Number </td>
     <td style="width:70%; background-color:#f7fff0"> {part11} </td>
  </tr>
  <tr>
     <td style="width:30%; background-color:#d5e3c8"> Summary </td>
     <td style="width:70%; background-color:#f7fff0"> {part12} </td>
  </tr>
  <tr>
     <td style="width:30%; background-color:#d5e3c8""> Creation Time </td>
     <td style="width:70%; background-color:#f7fff0"> {part13} </td>
  </tr>
  <tr>
     <td style="width:30%; background-color:#d5e3c8"> Status </td>
     <td style="width:70%; background-color:#f7fff0"> {part14} </td>
  </tr>

  <th colspan="2"> Bug Fix </th>
  <tr>
     <td style="width:30%; background-color:#d5e3c8"> Bugfix Commit </td>
     <td style="width:70%; background-color:#f7fff0"> {part21} </td>
  </tr>
  <tr>
     <td style="width:30%; background-color:#d5e3c8"> Bugfix Time </td>
     <td style="width:70%; background-color:#f7fff0"> {part22} </td>
  </tr>
...
for nodes in bugcomments:
    ...
    <tr>
        <td style="width:35%; background-color:#d5e3c8"> Creation Time </td>
        <td rowspan="width:65%" style="width:65%; background-color:#d5e3c8"> {part51} </td>
    </tr>
    <tr> <td colspan="2" style="background-color:#f7fff0"> {part52} </td> </tr>
    """.format(
        part51=nodepart51,
        part52=nodepart52,
    )
...
for nodes in classes:
    ...
    table_string_ranked_classdiagrams="""
    <tr>
        <td style="width:35%; background-color:#d5e3c8"> <a href={part31} target="myIframe"> {part32} </a> </td>
        <td style="width:65%; background-color:#d5e3c8">
            <div class="container">
            <iframe class="responsive-iframe" src={part31} name="myIframe">
                <a href={part31}>SELFHTML</a>
            </iframe>
            </div>
        </td>
    </tr>
    ...
    list_classdiagrams.append(table_string_ranked_classdiagrams)

    table_string_ranked_classifiers="""
    <tr>
        <td style="width:35%; background-color:#d5e3c8"> {part41} </td>
        <td rowspan="width:65%" style="width:65%; background-color:#f7fff0"> {part42} </td>
    </tr>
...
begin_tags = html_tag + body_tag
end_tags = body_end_tag + html_end_tag
#### half page top ###
halfpagetop_string = begin_tags + style_string + toppage_string + table_string_constant_rows
...
table_classdiagrams = table_string_ranked_classdiagrams_header + table_classdiagram_str

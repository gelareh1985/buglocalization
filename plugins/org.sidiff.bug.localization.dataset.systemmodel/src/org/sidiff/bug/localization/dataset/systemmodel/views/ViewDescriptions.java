...
public class ViewDescriptions {
	...
	public static ViewDescription UML_CLASS_DIAGRAM = SystemModelFactory.eINSTANCE.createViewDescription("UML Class Diagram", "Classes", "uml.class");
	
	public static ViewDescription UML_CLASS_OPERATION_CONTROL_FLOW = SystemModelFactory.eINSTANCE.createViewDescription("UML Activity Diagram", "Operation Control Flow Graph", "cfg.uml.activity");

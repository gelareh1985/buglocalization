...
public class ModelReference2SourceID implements ModelReferenceConverter<Integer> {

	private ModelElement2ID modelElement2ID;
	
	public ModelReference2SourceID(ModelElement2ID modelElement2ID) {
		this.modelElement2ID = modelElement2ID;
	}

	@Override
	public Integer convert(EObject source, EReference type, EObject target) {
		return modelElement2ID.convert(source);
	}

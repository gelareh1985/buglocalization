...
path = r"D:\files_MDEAI_original\Data_sets\buglocations_dataset\smalltest\positive/test_archive.7z"

save_path = "D:\\files_MDEAI_original\\Data_sets\\buglocations_dataset\\saved files\\dictionaries\\test\\"
...
dictionary_file_name = save_path + "word_dict_test_new"
dictionary_words.save(dictionary_file_name)

dictionary_file_name = save_path + "type_dict_test_new"
dictionary_types.save(dictionary_file_name)  
      
dictionary_file_name = save_path + "word_dict_test_bugreport_count_new"
save_word_count(dictionary_file_name, dictionary_words_bugreport_count)

dictionary_file_name = save_path + "word_dict_test_modelnode_count_new"
